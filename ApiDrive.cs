...
namespace Lector_de_Logs
{
    class ApiDrive
    {
        ...
        public static async Task DescargarArchivoPorNombreAsync(DriveService service, string nombreArchivo, string rutaBase)
        {
            ...
            listRequest.Q = $"name = '{nombreArchivo}' and trashed = false";
            ...
            if (archivo == null)
            {
                Console.WriteLine($"Archivo '{nombreArchivo}' no encontrado en Drive.");
                return;
            }
            ...
            Console.WriteLine($"Archivo descargado: {rutaDestino}");
        }
